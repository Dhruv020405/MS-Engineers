...
$logicalPath = array("products", "product_master", "product_part", "admin_part_click2.php");
$pro_part2 = isset($_GET['part2']) ? $_GET['part2'] : '';
...
$stmt = $connectDB->prepare('SELECT * FROM pro_master2 WHERE pro_part2 = :pro_part2');
$stmt->execute(['pro_part2' => $pro_part2]);
$parts = $stmt->fetchAll(PDO::FETCH_ASSOC);

// If no products are found, handle the error
if (count($parts) === 0) {
    echo "<div style='color: white; text-align: center; margin-top: 130px;'><h2>No products found for: " . htmlspecialchars($pro_part2) . "</h2></div>";
    exit();
}
...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .path-container { font-size: 0.85rem; padding: 8px 15px; }
            .path-container .separator { margin: 0 5px; }
        }
    </style>
</head>
<body>
    ...
    <div class="page-wrapper container">
        ...
        <div class="product-header">
            ...
            <div class="path-container">
                ...
                <?php if (!empty($pro_part2)): ?>
                    <span class="separator"><i class="fas fa-chevron-right"></i></span>
                    <a href="https://msengg.in/part_click2.php?part2=<?php echo urlencode($pro_part2); ?>&part=<?php echo urlencode($pro_part); ?>&name=<?php echo urlencode($product_name); ?>">
                        <?php echo htmlspecialchars($pro_part2); ?>
                    </a>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="row">
            <?php foreach ($parts as $index => $part): ?>
                <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                    ...
                    <!-- Direct PDF Link (Removed the col_count check) -->
