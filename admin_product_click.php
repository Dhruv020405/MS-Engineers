...
?>
    ...
    <div class="container mt-4">
        <br>
        <h2><?php echo htmlspecialchars($product_name); ?> 
        <br>
    <br>
    <div class="row">
        <?php foreach ($pro as $index => $product) { 
            ...
            <div class="col-md-4">
                <a href="admin_part_click.php?part=<?php echo urlencode($product['pro_part']); ?>" class="card-link">
                    <div class="card">
        ...
        <div class="col-md-4 col-sm-6 mb-4">
            <br>
            <div class="card">
            <a href="add_part.php?product_name=<?php echo urlencode($product_name); ?>" class="card-link d-flex align-items-center justify-content-center" style="height: 100%;">
    <div class="card-body text-center">
        <h1 class="card-title display-1">+</h1>
        <p class="card-text">Add New Part</p>
    </div>
</a>
            </div>
        </div>
